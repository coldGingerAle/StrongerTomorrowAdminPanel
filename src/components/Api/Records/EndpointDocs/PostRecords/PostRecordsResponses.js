...
export class PostRecordsResponses extends React.Component {
  constructor(props) {
    super(props);
  }
  render() {
            ...
            <CodeSnippet data={{
              ...
              "data": {
                "requirement": {
                  ...
                  "updatedAt": "2017-07-24T14:55:34.054Z",
                  "createdAt": "2017-07-24T14:55:34.054Z"
                }
              }
            }}/>
          </div>
            ...
            <CodeSnippet data={
              {
                "status": "fail",
                "data": {
                  "rs_id": "rs_id is required",
                  "req_id": "req_id is required",
